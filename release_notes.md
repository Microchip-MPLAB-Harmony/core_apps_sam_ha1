...
## Harmony 3 driver and system service application examples for SAM HA1 family v3.6.0
...
|:-----------------:|:-------------------:|
| [SAM HA1G16A Xplained Pro Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/ATSAMHA1G16A-XPRO) | 8 |
...
## Harmony 3 peripheral library application examples for SAM HA1 family  v3.4.0
...
## Harmony 3 peripheral library application examples for SAM HA1 family  v3.3.0
...
## Harmony 3 peripheral library application examples for SAM HA1 family  v3.2.0
...
| Development Kits  | MPLAB X applications |
|:-----------------:|:-------------------:|
| [SAM HA1G16A Xplained Pro Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/ATSAMHA1G16A-XPRO) | 9 |
...
## Harmony 3 driver and system service application examples for SAM HA1 family  v3.0.1
...
## Harmony 3 driver and system service application examples for SAM HA1 family  v3.0.0
