...
{"0": {
    ...
    "url": "http://localhost:4000/core_apps_sam_ha1/apps/fs/nvm_fat/readme.html#fat-filesystem-using-nvm-media",
    ...
    "url": "http://localhost:4000/core_apps_sam_ha1/apps/fs/nvm_fat/readme.html#description",
    ...
    "url": "http://localhost:4000/core_apps_sam_ha1/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#downloading-and-building-the-application"
  },"34": {
    "doc": "FAT filesystem using NVM Media",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | sam_ha1_xpro.X | SAM HA1G16A Xplained Pro Evaluation Kit | . |   |   | . Setting up SAM HA1G16A Xplained Pro Evaluation Kit . | Connect the Debug USB port on the board to the computer using a micro USB cable | . Note: ATSAMHA1G16A device in SAM HA1G16A Xplained Pro board is not recommended for new design, hence replace the device with ATSAMHA1G16AB device. Connect the supported external debugger to Cortex Debug Port . ",
    "url": "http://localhost:4000/core_apps_sam_ha1/apps/fs/nvm_fat/readme.html#setting-up-the-hardware",
    ...
    "url": "http://localhost:4000/core_apps_sam_ha1/apps/fs/nvm_fat/readme.html#running-the-application",
    "relUrl": "/apps/fs/nvm_fat/readme.html#running-the-application"
  },"36": {
    "doc": "FAT filesystem using NVM Media",
    "title": "FAT filesystem using NVM Media",
    "content": ". ",
    "url": "http://localhost:4000/core_apps_sam_ha1/apps/fs/nvm_fat/readme.html",
